...
const service = {
  ...
  pomodoroTimers: () => FIND_MANY_RESULT,
  pomodoroTimer: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("PomodoroTimer", () => {
  ...
  test("POST /pomodoroTimers", async () => {
  ...
  test("GET /pomodoroTimers/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pomodoroTimers"}/${nonExistingId}`)
  ...
  test("GET /pomodoroTimers/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/pomodoroTimers"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /pomodoroTimers existing resource", async () => {
